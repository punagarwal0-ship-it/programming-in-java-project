...
public class Main {
    ...
    static String t(String s){System.out.print(s);return sc.nextLine().trim();} static int i(String s){while(true)try{return Integer.parseInt(t(s));}catch(Exception e){System.out.println("Enter a valid integer.");}} static double d(String s){while(true)try{return Double.parseDouble(t(s));}catch(Exception e){System.out.println("Enter a valid number.");}}
}